...
def copy_files(src, dst, pattern):
	...
	for ext in ['.strm', '.nonfo', '.strm.alternative']:
...
class TMDB_API(object):
	...
	@staticmethod
	def upcoming(page=1):
		url = 'http://%s/3/movie/upcoming?api_key=' % TMDB_API.tmdb_api_key['host'] + TMDB_API.tmdb_api_key['key'] + '&language=ru'
		url += '&page={}'.format(page)
		return TMDB_API.tmdb_query(url)
		
	@staticmethod
	def now_playing(page=1):
		url = 'http://%s/3/movie/now_playing?api_key=' % TMDB_API.tmdb_api_key['host'] + TMDB_API.tmdb_api_key['key'] + '&language=ru'
		url += '&page={}'.format(page)
		return TMDB_API.tmdb_query(url)
	...
	@staticmethod
	def mult(page=1):
		url = 'http://%s/3/discover/movie?api_key=' % TMDB_API.tmdb_api_key['host'] + TMDB_API.tmdb_api_key['key'] + '&with_genres=16&language=ru'
		url += '&page={}'.format(page)
		return TMDB_API.tmdb_query(url)
	...
	def popular_tv(page=1):
		url = 'http://%s/3/tv/popular_tv?api_key=' % TMDB_API.tmdb_api_key['host'] + TMDB_API.tmdb_api_key['key'] + '&language=ru'
		url += '&page={}'.format(page)
		return TMDB_API.tmdb_query(url, 'tv')
		
	@staticmethod
	def on_the_air(page=1):
		url = 'http://%s/3/tv/on_the_air?api_key=' % TMDB_API.tmdb_api_key['host'] + TMDB_API.tmdb_api_key['key'] + '&language=ru'
		url += '&page={}'.format(page)
		return TMDB_API.tmdb_query(url, 'tv')
				
	@staticmethod
	def airing_today(page=1):
		url = 'http://%s/3/tv/airing_today?api_key=' % TMDB_API.tmdb_api_key['host'] + TMDB_API.tmdb_api_key['key'] + '&language=ru'
		url += '&page={}'.format(page)
		return TMDB_API.tmdb_query(url, 'tv')
	...
	@staticmethod
	def det_tv(page=1):
		url = 'http://%s/3/discover/tv?api_key=' % TMDB_API.tmdb_api_key['host'] + TMDB_API.tmdb_api_key['key'] + '&with_genres=10762&language=ru'
		url += '&page={}'.format(page)
		return TMDB_API.tmdb_query(url, 'tv')
	...
	@staticmethod
	def mult_tv(page=1):
		url = 'http://%s/3/discover/tv?api_key=' % TMDB_API.tmdb_api_key['host'] + TMDB_API.tmdb_api_key['key'] + '&with_genres=16&language=ru'
		url += '&page={}'.format(page)
		return TMDB_API.tmdb_query(url, 'tv')
